<?php
/**
 * Custom template tags for Mechanic theme
 *
 * Eventually, some of the functionality here could be replaced by core features.
 *
 */

if ( ! function_exists( 'mechanic_comment_nav' ) ) :
    /**
     * Display navigation to next/previous comments when applicable.
     *
     */
    function mechanic_comment_nav() {
...
function mechanic_numeric_posts_nav() {
    ...
    if ( get_previous_posts_link() )
        printf( '<li>%s</li>' . "\n", get_previous_posts_link($label = "<i class='icon-angle-left'></i>") );
