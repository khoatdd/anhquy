    ...
    <section id="main-slider" class="no-margin">
        <div class="carousel slide wet-asphalt">
            ...
            <div class="carousel-inner">
                <div class="item active" style="background-image: url(<?php bloginfo('template_directory'); ?>/images/slider/1.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                ...
                <div class="item" style="background-image: url(<?php bloginfo('template_directory'); ?>/images/slider/2.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                ...
                <div class="item" style="background-image: url(<?php bloginfo('template_directory'); ?>/images/slider/3.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content centered">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div id="scroller" class="carousel slide">
                        <div class="carousel-inner">
                            <?php DKProductSlider::print_inner_carousel_item_block(); ?>
                        </div>
                    </div>
                </div>
            </div><!--/.row-->
