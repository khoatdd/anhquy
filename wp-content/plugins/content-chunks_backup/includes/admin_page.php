<div class="wrap">
    ...
    <form action="" method="post" id="content_chunks_form">
        ...
        <p>
            Define the shortcode that will be used to trigger the retrieval of a Chunk, e.g. [get-chunk title="My Title"]<br/>
            <input type="text" id="shortcode_name" name="shortcode_name" value="<?php print $shortcode_name ?>" />
        </p>
