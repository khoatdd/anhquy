	...
	public static function register_post_types() {
		...
		register_post_type( 'product',
			apply_filters( 'woocommerce_register_post_type_product',
				array(
					'labels'              => array(
							'name'                  => __( '0. Products', 'woocommerce' ),
							'singular_name'         => __( '1. Product', 'woocommerce' ),
							'menu_name'             => _x( '2. Products', 'Admin menu name', 'woocommerce' ),
							'add_new'               => __( '3. Add Product', 'woocommerce' ),
							'add_new_item'          => __( '4. Add New Product', 'woocommerce' ),
							'edit'                  => __( '5. Edit', 'woocommerce' ),
							'edit_item'             => __( '6. Edit Product', 'woocommerce' ),
							'new_item'              => __( '7. New Product', 'woocommerce' ),
							'view'                  => __( '8. View Product', 'woocommerce' ),
							'view_item'             => __( '9. View Product', 'woocommerce' ),
							'search_items'          => __( '10. Search Products', 'woocommerce' ),
							'not_found'             => __( '11. No Products found', 'woocommerce' ),
							'not_found_in_trash'    => __( '12. No Products found in trash', 'woocommerce' ),
							'parent'                => __( '13. Parent Product', 'woocommerce' ),
							'featured_image'        => __( '14. Product Image', 'woocommerce' ),
							'set_featured_image'    => __( '15. Set product image', 'woocommerce' ),
							'remove_featured_image' => __( '16. Remove product image', 'woocommerce' ),
							'use_featured_image'    => __( '17. Use as product image', 'woocommerce' ),
						),
