...
<input type="text" class="widefat" id="[+title.id+]" name="[+title.name+]" value="[+title.value+]" /><br/>
<label for="[+seconds_shelf_life.id+]">Shelf Life (in seconds)<br/>
<input type="text" class="widefat" id="[+seconds_shelf_life.id+]" name="[+seconds_shelf_life.name+]" value="[+seconds_shelf_life.value+]"><br/></label>